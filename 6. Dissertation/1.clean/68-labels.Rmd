...
```{r}
df_gas <- read_csv("outputs/68_gas_clean.csv", show_col_types = FALSE)
df_heat <- read_csv("outputs/68_heat_clean.csv", show_col_types = FALSE)
df_tlr <- read_csv("outputs/68_tlr_clean.csv", show_col_types = FALSE)
df_tavg <- read_csv("outputs/68_tavg_clean.csv", show_col_types = FALSE)
```
...
```{r}
write.csv(df_main,"outputs/68_main.csv", row.names = FALSE)
```
