...
df_heat <- read_csv(
  "0.data/sensor/home167_kitchen1522_sensor8469_tempprobe_central-heating-flow.csv.gz", show_col_types = FALSE)
df_gas <- read_csv(
  "0.data/sensor/home167_cupboard1521_sensor8454_gas-pulse_gas.csv.gz", 
  show_col_types = FALSE)

df_tbath <- read_csv(
  "0.data/auxil/home167_bathroom1527_sensor8509_room_temperature.csv.gz", show_col_types = FALSE)
df_tbed1 <- read_csv(
  "0.data/auxil/home167_bedroom1523_sensor8494_room_temperature.csv.gz", show_col_types = FALSE)
df_tbed2 <- read_csv(
  "0.data/auxil/home167_bedroom1526_sensor8503_room_temperature.csv.gz", show_col_types = FALSE)
df_thall <- read_csv(
  "0.data/auxil/home167_cupboard1521_sensor8489_room_temperature.csv.gz", show_col_types = FALSE)
df_tkitch <- read_csv(
  "0.data/auxil/home167_kitchen1522_sensor8462_room_temperature.csv.gz", show_col_types = FALSE)
df_tlr <- read_csv(
  "0.data/auxil/home167_livingroom1524_sensor8499_room_temperature.csv.gz", show_col_types = FALSE)
...
```{r}
# save main outputs
write.csv(df_gas_clean,"outputs/167_gas_clean.csv", row.names = FALSE)
write.csv(df_heat_clean,"outputs/167_heat_clean.csv", row.names = FALSE)
write.csv(df_tavg_clean,"outputs/167_tavg_clean.csv", row.names = FALSE)
write.csv(df_tlr_clean,"outputs/167_tlr_clean.csv", row.names = FALSE)
```
