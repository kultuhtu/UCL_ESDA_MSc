...
```{r}
df_gas <- read_csv("outputs/70_gas_clean.csv", show_col_types = FALSE)
df_heat <- read_csv("outputs/70_heat_clean.csv", show_col_types = FALSE)
df_tlr <- read_csv("outputs/70_tlr_clean.csv", show_col_types = FALSE)
df_tavg <- read_csv("outputs/70_tavg_clean.csv", show_col_types = FALSE)
```
...
```{r}
write.csv(df_main,"outputs/70_main.csv", row.names = FALSE)
```
