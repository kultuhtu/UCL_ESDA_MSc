...
```{r}
df_gas <- read_csv("outputs/67_gas_clean.csv", show_col_types = FALSE)
df_heat <- read_csv("outputs/67_heat_clean.csv", show_col_types = FALSE)
df_tlr <- read_csv("outputs/67_tlr_clean.csv", show_col_types = FALSE)
df_tavg <- read_csv("outputs/67_tavg_clean.csv", show_col_types = FALSE)
```
...
```{r}
write.csv(df_main,"outputs/67_main.csv", row.names = FALSE)
```
