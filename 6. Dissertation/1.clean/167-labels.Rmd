...
```{r}
df_gas <- read_csv("outputs/167_gas_clean.csv", show_col_types = FALSE)
df_heat <- read_csv("outputs/167_heat_clean.csv", show_col_types = FALSE)
df_tlr <- read_csv("outputs/167_tlr_clean.csv", show_col_types = FALSE)
df_tavg <- read_csv("outputs/167_tavg_clean.csv", show_col_types = FALSE)
```
...
ggplot() +
  ...
  geom_line(data=df_heat_small, aes(x=date, y=t), 
            alpha=0.7,  color="red") +
  geom_line(data=df_tlr_small, aes(x=date, y=T*3), 
            alpha=0.7,  color="blue") +
  geom_line(data=df_tavg_small, aes(x=date, y=T*3), 
...
ggplot() +
  ...
  geom_line(data=df_heat_small, aes(x=date, y=t), 
            alpha=0.7,  color="red") +
  geom_line(data=df_tlr_state, aes(x=date, y=T*3), 
            alpha=0.7,  color="blue") +
  geom_line(data=df_tavg_state, aes(x=date, y=T*3), 
            alpha=0.7,  color="purple") +
  xlab("") + ylab("") +
  theme_light()+
...
for(n in 1:(length(df_heat_state$t))){
  if(df_heat_state$t[n]>1.5*mean(df_heat$t)){df_heat_state$state[n]=1}
  c = c+1
}
...
ggplot() +
  ...
  geom_line(data=df_heat_state, aes(x=date, y=t), 
            alpha=0.7,  color="red") +
  geom_line(data=df_tlr_final, aes(x=date, y=T*3), 
            alpha=0.7,  color="blue") +
  geom_line(data=df_tavg_final, aes(x=date, y=T*3), 
            alpha=0.7,  color="purple") +
  xlab("") + ylab("") +
  theme_light()+
  ggtitle("Gas, Heat and Temperature")
...
```{r}
write.csv(df_main,"outputs/167_main.csv", row.names = FALSE)
```
